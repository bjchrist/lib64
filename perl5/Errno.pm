...
"x86_64-linux-thread-multi-4.14.114-105.126.amzn2.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-4.14.114-105.126.amzn2.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
